# Step 3: TypeScript Types & Mock Data
    ...
    activities: [
      {
        ...
        type: 'flight',
        startTime: new Date('2025-03-15T06:30:00'),
        endTime: new Date('2025-03-15T10:45:00'),
        duration: 195,
      ...
      },
      {
        ...
        type: 'restaurant',
        startTime: new Date('2025-03-15T20:00:00'),
        duration: 90,
        location: { 
          name: 'Nomad', 
    ...
    activities: [
      {
        ...
        type: 'activity',
        startTime: new Date('2025-03-16T05:30:00'),
        duration: 240,
      ...
      },
      {
        ...
        type: 'activity',
        startTime: new Date('2025-03-16T17:00:00'),
        duration: 180,
    ...
    activities: [
      {
        ...
        type: 'activity',
        startTime: new Date('2025-03-17T08:00:00'),
        duration: 540,
      ...
      },
      {
        ...
        type: 'restaurant',
        startTime: new Date('2025-03-17T20:00:00'),
        duration: 120,
...
export const mockExpenses: Expense[] = [
  {
    ...
    category: 'transport',
    splitBetween: [
      { oderId: 'traveler-1', travelerName: 'Alex', amount: 180, settled: true },
      { oderId: 'traveler-2', travelerName: 'Sarah', amount: 180, settled: true },
      { oderId: 'traveler-3', travelerName: 'Mike', amount: 180, settled: false },
      { oderId: 'traveler-4', travelerName: 'Emma', amount: 180, settled: false },
    ],
  ...
  },
  {
    ...
    splitBetween: [
      { oderId: 'traveler-1', travelerName: 'Alex', amount: 120, settled: false },
      { oderId: 'traveler-2', travelerName: 'Sarah', amount: 120, settled: true },
      { oderId: 'traveler-3', travelerName: 'Mike', amount: 120, settled: false },
      { oderId: 'traveler-4', travelerName: 'Emma', amount: 120, settled: true },
    ],
  ...
  },
  {
    ...
    category: 'activity',
    splitBetween: [
      { oderId: 'traveler-1', travelerName: 'Alex', amount: 150, settled: true },
      { oderId: 'traveler-2', travelerName: 'Sarah', amount: 150, settled: false },
      { oderId: 'traveler-3', travelerName: 'Mike', amount: 150, settled: false },
      { oderId: 'traveler-4', travelerName: 'Emma', amount: 150, settled: false },
    ],
  ...
  },
  {
    ...
    category: 'food',
    splitBetween: [
      { oderId: 'traveler-1', travelerName: 'Alex', amount: 35, settled: false },
      { oderId: 'traveler-2', travelerName: 'Sarah', amount: 35, settled: false },
      { oderId: 'traveler-3', travelerName: 'Mike', amount: 35, settled: true },
      { oderId: 'traveler-4', travelerName: 'Emma', amount: 35, settled: false },
    ],
    date: new Date('2025-03-15'),
...
This gives you plenty of time to continue with the rest of your Day 2 plans! 🏍️`,
